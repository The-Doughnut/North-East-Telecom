      ...
      __wm.ajax('GET', url, (http) => {
        if (http.status == 200 && http.responseText) {
          ...
          if (meta && meta.status_code != null) {
            ...
            // status_code 1 is "archived and indexed" - this should not
            // happen with existence of status_code field. so it's taken
            // as "unknown state"
            ...
            for (var i=0; i<meta['formats'].length; i++) {
              ...
              vinfo.location = '/web/' + video.timestamp + '_id/' + video.url;
              vinfo.ptype = 'video/' + video.ext;
